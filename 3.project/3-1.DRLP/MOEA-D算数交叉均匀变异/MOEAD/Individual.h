...
public:
	   ...
	   void   SinglePointXover(vector<int> &mark ,CIndividual &parent ,vector<double> &lambda, char *strFuncType);
	   void   SinglePointInsert(CIndividual &parent ,vector<double> &lambda, char *strFuncType);
